...
public class StiffScaffoldingBlock extends Block implements IWaterLoggable {
    ...
    public static final IntegerProperty DISTANCE = IntegerProperty.create("distances", 0, 14);
    public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
    public static final BooleanProperty BOTTOM = BlockStateProperties.BOTTOM;

    public StiffScaffoldingBlock(AbstractBlock.Properties properties) {
        super(properties);
        this.setDefaultState(this.stateContainer.getBaseState().with(DISTANCE, Integer.valueOf(14)).with(WATERLOGGED, Boolean.valueOf(false)).with(BOTTOM, Boolean.valueOf(false)));
    }
    ...
    public void tick(BlockState state, ServerWorld worldIn, BlockPos pos, Random rand) {
        ...
        if (blockstate.get(DISTANCE) == 14) {
            if (state.get(DISTANCE) == 14) {
    ...
    public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
        return getDistance(worldIn, pos) < 14;
    }
    ...
    private boolean hasScaffoldingBelow(IBlockReader blockReader, BlockPos pos, int distance) {
        return distance > 0 && !blockReader.getBlockState(pos.down()).matchesBlock(this);
    }
    ...
    public static int getDistance(IBlockReader blockReader, BlockPos pos) {
        ...
        int i = 14;
        if (blockstate.matchesBlock(EBlocks.STIFF_SCAFFOLDING)) {
        ...
        for(Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            if (blockstate1.matchesBlock(EBlocks.STIFF_SCAFFOLDING)) {
    ...
    static {
        ...
        FULL_SHAPE = VoxelShapes.or(StiffScaffoldingBlock.BOTTOM_SLAB_SHAPE, TOP_SLAB_SHAPE, voxelshape6, voxelshape5, voxelshape8, voxelshape7);
    }
